...
INSERT INTO `project_acl` (`acl_rule_id`, `tenant_id`, `effect`, `identity`, `permission_id`, `project_resource_id`)
VALUES ('1', 'demo.com', 'ALLOW', 'admin@demo.com', 'read-project', '*'),
       ('2', 'demo.com', 'ALLOW', 'admin@demo.com', 'assign-read-project', '*'),
       ('3', 'demo.com', 'ALLOW', 'admin@demo.com', 'update-project', '*'),
       ('4', 'demo.com', 'ALLOW', 'admin@demo.com', 'assign-update-project', '*'),
       ('5', 'demo.com', 'ALLOW', 'admin@demo.com', 'delete-project', '*'),
       ('6', 'demo.com', 'ALLOW', 'admin@demo.com', 'assign-delete-project', '*'),
       ('7', 'demo.com', 'ALLOW', 'admin@demo.com', 'create-project', '*'),
       ('8', 'demo.com', 'ALLOW', 'admin@demo.com', 'assign-create-project', '*');

INSERT INTO `tenants` (`id`, `display_name`, `enabled`, `created_by`, `created_on`, `last_updated_by`, `last_updated_on`)
VALUES ('demo.com', 'Demo-Org', b'1', 'admin@zigmoi.com', '2019-09-04 13:03:48', 'admin@zigmoi.com', '2019-09-04 13:03:48'),
...
VALUES ('admin@zigmoi.com', 'ROLE_SUPER_ADMIN'),
       ('admin@demo.com', 'ROLE_TENANT_ADMIN');

INSERT INTO `users` (`user_name`, `display_name`, `email`, `enabled`, `first_name`, `last_name`, `password`, `created_by`, `created_on`, `last_updated_by`, `last_updated_on`)
VALUES ('admin@demo.com', 'Tenant Admin', 'admin@demo.com', b'1', 'Tenant Admin', 'Tenant Admin', '$2a$04$Yh6df.WoQKnoU9KNBeWIAeI1RWSPLSiLpCBESvkgUbkqF8U9VywhS', 'admin@demo.com', '2019-09-04 13:03:48', 'admin@demo.com', '2019-09-04 13:03:48'),
       ('admin@zigmoi.com', 'Zigmoi', 'admin@zigmoi.com', b'1', 'zigmoi', 'zigmoi', '$2a$04$dvoJcMTDPkaQvB0slTdMBOLdinrh26jFpLZk1t04/fVJTblWtd736', 'admin@zigmoi.com', '2019-09-04 13:03:48', 'admin@zigmoi.com', '2019-09-04 13:03:48');
